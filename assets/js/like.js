...
var button    = $(this);
$.post('http://localhost:8888/UpToSpace/core/ajax/like.php', {like:tweet_id, user_id:user_id}, function(){
  counter.show();
...
var count     = counter.text();
var button    = $(this);
$.post('http://localhost:8888/UpToSpace/core/ajax/like.php', {unlike:tweet_id, user_id:user_id}, function(){
  counter.show();
